        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <h3>Leaderboards</h3>
              <p>
                View rankings, track your progress, and compete with players
                worldwide in our comprehensive leaderboard system.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="how-to-play-section">
          ...
          <div className="how-to-content">
            <div className="how-to-text">
              ...
              <p>
                Super Tic Tac Toe takes the classic game to the next level with
                a 3x3 grid of smaller Tic Tac Toe boards. Your move determines
                which board your opponent must play on next, creating a
                strategic layer of complexity.
              </p>
          ...
          <div className="footer-content">
            ...
            <div className="footer-built-by">
              ...
              <div className="footer-social">
                ...
                <a href="mailto:abiy.biru78@gmail.com" className="social-link">
                  <span>📧</span> Email
                </a>
              </div>
            </div>
